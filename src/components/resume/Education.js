    ...
    // Experience
      ...
      <div className=' col-span-4'>
        ...
        <ResumeCard
          ...
          title="B.C.Sc"
          subTitle=""
          des="2007 ခုနှစ်တွင် စစ်တက္ကသိုလ်မှ ကွန်ပျူတာသိပ္ပံဘွဲ့ (BCSc) ကို မဟာတန်းတက်ရောက်ရန်အဆင့်မီဖြင့် အောင်မြင်ခဲ့ပါသည်။ " />
        <ResumeCard
          badge="2011"
          title="M.C.Sc"
          subTitle=""
          des="2011 ခုနှစ်တွင် စစ်တက္ကသိုလ်၊ စာပေ(၂)မှ မဟာကွန်ပျူတာသိပ္ပံ(Master of Computer Science) ဘွဲ့ကို ရရှိခဲ့ပါသည်။ "/>
          </div>
    </div>
  )
}
